-- Update get_dashboard_stats() to include incoming stock and reservation metrics
...
-- Update get_inventory_pivot_summary() to include incoming stock and reservation details
